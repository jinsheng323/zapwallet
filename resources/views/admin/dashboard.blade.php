...
<head>
  ...
  <title>ZAPWallet | Dashboard 2</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">ZapWallet</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<!-- overlayScrollbars -->
<script src="/AdminLTE/AdminLTE/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js"></script>
<!-- AdminLTE App -->
<script src="/AdminLTE/AdminLTE/dist/js/adminlte.js"></script>
...
<!-- PAGE PLUGINS -->
<!-- jQuery Mapael -->
<script src="/AdminLTE/AdminLTE/plugins/jquery-mousewheel/jquery.mousewheel.js"></script>
<script src="/AdminLTE/AdminLTE/plugins/raphael/raphael.min.js"></script>
<script src="/AdminLTE/AdminLTE/plugins/jquery-mapael/jquery.mapael.min.js"></script>
<script src="/AdminLTE/AdminLTE/plugins/jquery-mapael/maps/usa_states.min.js"></script>
<!-- ChartJS -->
<script src="/AdminLTE/AdminLTE/plugins/chart.js/Chart.min.js"></script>

<!-- PAGE SCRIPTS -->
<script src="/AdminLTE/AdminLTE/dist/js/pages/dashboard2.js"></script>
</body>
</html>
